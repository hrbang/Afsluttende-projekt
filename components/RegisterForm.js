                ...
                <Form>
                    <Form.Group className="mb-3" controlId="formBasicFirstname">
                        ...
                        <div className="d-flex">
                            <Form.Control className="me-1" type="name" placeholder="First name" ref={(input) => (form.current.firstName = input)} />
                            <Form.Control className="ms-1" type="name" placeholder="Last name" ref={(input) => (form.current.lastName = input)} />
                        </div>
                    </Form.Group>
                    ...
                    <Form.Group className="mb-3" controlId="formBasicPassword">
                        ...
                        <div className="d-flex">
                            <Form.Control className="me-1" type="password" placeholder="Password" onChange={onPasswordInputsChange} ref={(input) => (form.current.password = input)} />
                            <Form.Control className="ms-1" type="password" placeholder="Confirm Password" onChange={onPasswordInputsChange} ref={(input) => (form.current.confirmPassword = input)} />
                        </div>
                    </Form.Group>
