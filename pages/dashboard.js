    ...
    return (
        <div className="main">
            <div className="dashboard">
              ...
              <Col lg={4}>
                <div className='role content' data-testid='role'>
                  <p className='role_title cat'>Role</p>
                  <p className='role_pass item'>{user.role}</p>
                </div>
              </Col>
              <Col lg={12} className='mb-4' data-testid='joke'>
                <div className='description content'>
                  <p className='desc_title cat'>Random Dad Joke</p>
                  <div className='dad-joke'>
                    <p className='joke'>{jokeSetup}</p>
                    <p
                      onClick={() => handlePunchlineShow()}
                      className={jokeShow == true ? 'reveal show' : 'punchline show'}
                    >
                      {jokeShow == true ? `${jokePunchline}` : 'Reveal punchline'}
                    </p>
                  </div>
                </div>
              </Col>
              <Col lg={12} className='mb-4' data-testid='description'>
                <div className='description content'>
                  <p className='desc_title cat'>Description</p>
                  <Form>
                    <Form.Group className='mb-3' controlId='formBasicPassword'>
              ...
              <Col lg={12} className='mb-4' data-testid='password'>
                <div className='password content'>
